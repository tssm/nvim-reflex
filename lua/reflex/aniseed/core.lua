...
local _1_
do
  local name_4_auto = "reflex.aniseed.core"
  local module_5_auto
  do
...
local function _6_(...)
  ...
  local function _5_()
    return {autoload("reflex.aniseed.view")}
  end
  ok_3f_21_auto, val_22_auto = pcall(_5_)
  if ok_3f_21_auto then
    _1_["aniseed/local-fns"] = {autoload = {view = "reflex.aniseed.view"}}
    return val_22_auto
  else
...
local _2amodule_name_2a = "reflex.aniseed.core"
