...
local _1_
do
  local name_4_auto = "reflex.aniseed.nvim.util"
  local module_5_auto
  do
...
local autoload
local function _3_(...)
  return (require("reflex.aniseed.autoload")).autoload(...)
end
autoload = _3_
local function _6_(...)
  local ok_3f_21_auto, val_22_auto = nil, nil
  local function _5_()
    return {autoload("reflex.aniseed.nvim")}
  end
  ok_3f_21_auto, val_22_auto = pcall(_5_)
  if ok_3f_21_auto then
    _1_["aniseed/local-fns"] = {autoload = {nvim = "reflex.aniseed.nvim"}}
    return val_22_auto
  else
...
local _2amodule_name_2a = "reflex.aniseed.nvim.util"
